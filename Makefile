...
MKP = $(shell docker exec -u cmk checkmk-php_fpm bash -c "ls -1 /omd/sites/cmk/local/share/check_mk/enabled_packages/*mkp")
...
_pack:
	docker exec -u cmk ${CONTAINER} bash -l -c "mkp package /omd/sites/cmk/var/check_mk/packages/${PKG}"
